...
install_xcframework "${PODS_ROOT}/BlackBerryDynamics/Frameworks/BlackBerryDynamics.xcframework" "BlackBerryDynamics/BlackBerryDynamics" "framework" "ios-arm64" "ios-x86_64-simulator"
install_xcframework "${PODS_ROOT}/BlackBerryDynamics/Frameworks/BlackBerryCerticom.xcframework" "BlackBerryDynamics/BlackBerryDynamics" "framework" "ios-x86_64-simulator" "ios-arm64"
install_xcframework "${PODS_ROOT}/BlackBerryDynamics/Frameworks/BlackBerryCerticomSBGSE.xcframework" "BlackBerryDynamics/BlackBerryDynamics" "framework" "ios-x86_64-simulator" "ios-arm64"
